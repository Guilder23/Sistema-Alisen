...
class VentaAdmin(admin.ModelAdmin):
    list_display = ['codigo', 'cliente', 'ubicacion', 'tipo_pago', 'metodo_pago', 'descuento_tipo', 'estado', 'total', 'fecha_elaboracion']
    list_filter = ['tipo_pago', 'metodo_pago', 'descuento_tipo', 'estado', 'fecha_elaboracion']
